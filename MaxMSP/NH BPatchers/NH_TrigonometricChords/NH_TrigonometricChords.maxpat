...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 446.5, 778.0, 50.0, 35.0 ],
					"text" : "0. 1.7333"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 376.0, 778.0, 50.0, 22.0 ],
					"text" : "1. 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 296.0, 778.0, 50.0, 22.0 ],
					"text" : "0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 374.0, 702.0, 50.0, 22.0 ],
					"text" : "0. 1. 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 412.0, 613.0, 135.0, 22.0 ],
					"text" : "0. 0. 1. 1.7333 2. 0."
				}
...
, 			{
				"box" : 				{
					...
					"clickadd" : 0,
					"data" : [ 						{
							"addpoints" : [ 0.0, 0.0, 0, 1.0, 1.7333, 0, 2.0, 0.0, 0 ]
						}
, 						{
...
, 			{
		...
		"parameters" : 		{
			"obj-232" : [ "number", "number", 0 ],
			"obj-260" : [ "live.gain~", "live.gain~", 0 ],
			"obj-266" : [ "number[1]", "number[1]", 0 ],
			"obj-268" : [ "number[2]", "number[2]", 0 ],
			"obj-271" : [ "number[3]", "number[3]", 0 ],
			"parameterbanks" : 			{
