...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 867.0, 735.0, 69.0, 22.0 ],
					"text" : "route 54 55"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 934.0, 779.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1322.0, 779.0, 107.0, 22.0 ],
					"text" : "scale 0 127 -70. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 16,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 1117.75, 293.0, 781.0, 22.0 ],
					"text" : "route 65 66 67 68 69 70 71 72 73 74 75 76 77 78 79"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 646.5, 310.166668236255646, 86.0, 335.0 ],
					"presentation" : 1,
					"presentation_linecount" : 13,
					"presentation_rect" : [ 650.0, 212.500000655651093, 122.0, 225.0 ],
					"text" : "MIDI CONTROLS\n\nVolume: cc 56-63\n\nPan: cc 120-127\n\nSends: cc 65-79\n\nInserts: cc 54-55\n\nOutput: cc 7\n\n\n",
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-107" : [ "live.dial[15]", "A", 0 ],
			"obj-123" : [ "live.dial[23]", "B", 0 ],
			"obj-152" : [ "live.dial[20]", "B", 0 ],
			"obj-153" : [ "live.dial[25]", "A", 0 ],
			"obj-158" : [ "live.dial[26]", "B", 0 ],
			"obj-159" : [ "live.dial[27]", "A", 0 ],
			"obj-164" : [ "live.dial[21]", "B", 0 ],
			"obj-165" : [ "live.dial[28]", "A", 0 ],
			"obj-170" : [ "live.dial[29]", "B", 0 ],
			"obj-171" : [ "live.dial[22]", "A", 0 ],
			"obj-176" : [ "live.dial[30]", "B", 0 ],
			"obj-177" : [ "live.dial[31]", "A", 0 ],
			"obj-182" : [ "live.dial[32]", "B", 0 ],
			"obj-183" : [ "live.dial[33]", "A", 0 ],
			"obj-188" : [ "live.dial[24]", "B", 0 ],
			"obj-189" : [ "live.dial[34]", "A", 0 ],
			"obj-2" : [ "live.gain~[1]", "live.gain~", 0 ],
			"obj-23" : [ "live.dial", "Pan", 0 ],
			"obj-24" : [ "live.dial[1]", "Pan", 0 ],
			"obj-26" : [ "live.dial[2]", "Pan", 0 ],
			"obj-28" : [ "live.dial[3]", "Pan", 0 ],
			"obj-3" : [ "live.gain~[2]", "live.gain~", 0 ],
			"obj-30" : [ "live.dial[4]", "Pan", 0 ],
			"obj-32" : [ "live.dial[5]", "Pan", 0 ],
			"obj-34" : [ "live.dial[6]", "Pan", 0 ],
			"obj-36" : [ "live.dial[7]", "Pan", 0 ],
			"obj-4" : [ "live.gain~[3]", "live.gain~", 0 ],
			"obj-5" : [ "live.gain~[4]", "live.gain~", 0 ],
			"obj-6" : [ "live.gain~[5]", "live.gain~", 0 ],
			"obj-7" : [ "live.gain~[6]", "live.gain~", 0 ],
			"obj-8" : [ "live.gain~[7]", "live.gain~", 0 ],
			"obj-9" : [ "live.gain~[8]", "live.gain~[8]", 0 ],
			"obj-94" : [ "live.gain~[9]", "live.gain~[8]", 0 ],
			"obj-97" : [ "live.gain~[10]", "live.gain~[8]", 0 ],
			"parameterbanks" : 			{
