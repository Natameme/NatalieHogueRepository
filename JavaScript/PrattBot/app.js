...
//CONDITIONAL LOGIC
  //Trash
  if (cans == dayWeek.Day){
    console.log("Today's Date is " + mdy );
    console.log("Remember to Put out your cans! Trash Pickup is Tomorrow.")
  } else if (trashDay == dayWeek.Day) {
    console.log("Today's Date is " + mdy );
    console.log("Trash Pickup is Today! Remember to Bring in your cans this evening.")
  }
  //Sweep
  if (dayWeek.Day == 1){
        if (dayWeek.Week == 1 || dayWeek.Week == 3){
        console.log("Today's Date is " + mdy );
        console.log("Street Sweeping is Today! Make sure to move your car to the EVEN side of the street");
      } else if (dayWeek.Week == 2 || dayWeek.Week == 4){
        console.log("Today's Date is " + mdy );
        console.log("Street Sweeping is Today! Make sure to move your car to the ODD side of the street");
      }
  } else {
    console.log("Today's Date is " + mdy );
  }
}
function main(){setInterval(function(){ // Set interval for checking
