...
//Compile with:
//clang OrganFirstBuild.c -o Organ -lportaudio -lportmidi
//Run with:
//./Organ

//clang OrganFirstBuild.c -o Organ -lportaudio -lportmidi && ./Organ
  ...
  if(Pm_Poll(sineWave->inputStream)){
    ...
    //printf("velocity: %d \n---\n", Pm_MessageData2(sineWave->event.message));
      ...
      for(int i = 0; i < kNumVoices; i++){
          ...
          sineWave->amplitude = bag[i][1];//turn off note
    ...
    //  printf("FREQ: v1[%f] v2[%f] v3[%f] v4[%f]\n", sineWave->frequency, sineWave->frequency, sineWave->frequency, sineWave->frequency);
    //  printf("AMP : v1[%f] v2[%f] v3[%f] v4[%f]\n", sineWave->amplitude, sineWave->amplitude, sineWave->amplitude, sineWave->amplitude);
  }
}
//------------------------------------------------------------------------------------
int renderCallback(
