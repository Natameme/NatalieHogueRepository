...
//Compile with:
//clang CycleSampler.c -o CycleSampler -lportaudio -lportmidi
//Run with:
//./CycleSampler

//clang CycleSampler.c -o CycleSampler -lportaudio -lportmidi && ./CycleSampler
...
//OPEN STOP FILES
//Adapted from code in 03.Playback.c // 11.Real-TimeAudio/02.PortAudio/03.Playback.c
...
int openInputSndFile(SoundFile *sndFile){
  ...
  sndFile->file = sf_open(fileName[][i], SFM_READ, &sndFile->info);
